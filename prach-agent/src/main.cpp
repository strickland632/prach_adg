...
// send PRACH CP+sequence  -> DO IN SOURCE when i have zmq and allat done
                         ...
                         double seconds_in_future = 0.050 /* 50 ms */)
{
 ...
 // End of burst -> i dot really to send null ptr i dont think
...
int main(int argc, char** argv)
{
 ...
 // spacing between bursts -> make part of config??
 double base_offset_s  = 0.050;   // first burst 
 double burst_spacing  = 0.005;   // between bursts
//  while (1){
 for (uint32_t seq_index = 0; seq_index < max_preambles; ++seq_index) {
   ...
   //when does it full the buffer??????? when how to write to iq file
